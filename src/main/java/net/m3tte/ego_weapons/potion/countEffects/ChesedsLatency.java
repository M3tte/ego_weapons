...
public class ChesedsLatency extends CountPotencyStatus {
    public ChesedsLatency() {
   ...
   static AttributeModifier attackSpeedMod = new AttributeModifier(UUID.fromString("fc414f98-640e-4b92-88d9-6ce88ebff984"), "chesedAttackSpeed", 0.045, AttributeModifier.Operation.ADDITION);
    static AttributeModifier impactMod = new AttributeModifier(UUID.fromString("fc414f98-930e-3c62-78d9-6ce88ebff984"), "chesedImpact", 0.05, AttributeModifier.Operation.ADDITION);
    ...
    public void decrement(LivingEntity entity, int limit, int potency) {
        ...
        if ((previousPotency - potency) > 0) {
            entity.addEffect(new EffectInstance(this, 999999, previousPotency-potency-1));
        }
    }
