...
public class EgoWeaponsModElements {
	public final List<ModElement> elements = new ArrayList<>();
	public final List<Supplier<Block>> blocks = new ArrayList<>();
	public final List<Supplier<Item>> items = new ArrayList<>();
	public final List<Supplier<Enchantment>> enchantments = new ArrayList<>();
	public static Map<ResourceLocation, net.minecraft.util.SoundEvent> sounds = EgoWeaponsSounds.SOUNDS;

	public EgoWeaponsModElements() {
		try {
			ModFileScanData modFileInfo = ModList.get().getModFileById(EgoWeaponsMod.MODID).getFile().getScanResult();
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		protected final EgoWeaponsModElements elements;
		protected final int sortid;

		public ModElement(EgoWeaponsModElements elements, int sortid) {
