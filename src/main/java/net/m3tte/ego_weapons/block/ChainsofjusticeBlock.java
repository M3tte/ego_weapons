...
import net.m3tte.ego_weapons.procedures.legacy.ChainsofjusticecollideProcedure;
import net.m3tte.ego_weapons.procedures.legacy.ChainsofjudgementtickProcedure;
...
public class ChainsofjusticeBlock extends EgoWeaponsModElements.ModElement {
	@ObjectHolder("ego_weapons:chainsofjustice")
	public static final Block block = null;
	@ObjectHolder("ego_weapons:chainsofjustice")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public ChainsofjusticeBlock(EgoWeaponsModElements instance) {
		super(instance, 149);
