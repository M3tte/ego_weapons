...
public class AnchorpointBlock extends EgoWeaponsModElements.ModElement {
	@ObjectHolder("ego_weapons:anchorpoint")
	public static final Block block = null;

	public AnchorpointBlock(EgoWeaponsModElements instance) {
		super(instance, 93);
	}
