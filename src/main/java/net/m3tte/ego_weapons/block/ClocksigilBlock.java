...
import net.m3tte.ego_weapons.procedures.legacy.ClocksigilClientDisplayRandomTickProcedure;
...
public class ClocksigilBlock extends EgoWeaponsModElements.ModElement {
	@ObjectHolder("ego_weapons:clocksigil")
	public static final Block block = null;

	public ClocksigilBlock(EgoWeaponsModElements instance) {
		super(instance, 48);
	}
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new BlockItem(block, new Item.Properties().tab(ItemGroup.TAB_DECORATIONS)).setRegistryName(block.getRegistryName()));
	}
