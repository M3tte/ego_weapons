				...
				if (entity instanceof PlayerEntity) {
					...
					if (entitypatch.getHoldingItemCapability(Hand.MAIN_HAND).getStyle(entitypatch) == TCorpStyles.FURIOSO)
						switch ((int) (entity.getCapability(EgoWeaponsModVars.PLAYER_VARIABLES_CAPABILITY, null)
							...
							case 0:
								entitypatch.playAnimationSynchronized(EgoWeaponsAnimations.ATELIER_REVOLVER_FURIOSO_1, 0);
								break;
							case 1:
								if (entitypatch.getOriginal().getItemInHand(Hand.OFF_HAND).getItem().equals(EgoWeaponsItems.ATELIER_LOGIC_PISTOLS.get()))
									entitypatch.playAnimationSynchronized(EgoWeaponsAnimations.ATELIER_REVOLVER_FURIOSO_2, 0);
								else
									entitypatch.playAnimationSynchronized(EgoWeaponsAnimations.ATELIER_REVOLVER_FURIOSO_1, 0);
						}
					else
						switch ((int) (entity.getCapability(EgoWeaponsModVars.PLAYER_VARIABLES_CAPABILITY, null)
								.orElse(new EgoWeaponsModVars.PlayerVariables())).gunMagSize) {
							case 0:
								entitypatch.playAnimationSynchronized(EgoWeaponsAnimations.ATELIER_REVOLVER_FIRE_1, 0);
								break;
							case 1:
								if (entitypatch.getOriginal().getItemInHand(Hand.OFF_HAND).getItem().equals(EgoWeaponsItems.ATELIER_LOGIC_PISTOLS.get()))
									entitypatch.playAnimationSynchronized(EgoWeaponsAnimations.ATELIER_REVOLVER_FIRE_2, 0);
								else
									entitypatch.playAnimationSynchronized(EgoWeaponsAnimations.ATELIER_REVOLVER_FIRE_1, 0);
								break;
						}
