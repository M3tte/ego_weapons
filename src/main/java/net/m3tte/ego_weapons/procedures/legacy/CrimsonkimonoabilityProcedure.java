...
public class CrimsonkimonoabilityProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				EgoWeaponsMod.LOGGER.warn("Failed to load dependency world for procedure Crimsonkimonoability!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				EgoWeaponsMod.LOGGER.warn("Failed to load dependency x for procedure Crimsonkimonoability!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				EgoWeaponsMod.LOGGER.warn("Failed to load dependency y for procedure Crimsonkimonoability!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				EgoWeaponsMod.LOGGER.warn("Failed to load dependency z for procedure Crimsonkimonoability!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				EgoWeaponsMod.LOGGER.warn("Failed to load dependency entity for procedure Crimsonkimonoability!");
			return;
		}
		...
		if (world instanceof ServerWorld) {
			((ServerWorld) world).sendParticles(CrimsonfanparticleParticle.particle, x, (y + entity.getBbHeight() / 2), z, (int) 8, 0.1, 0.4, 0.1,
					0.04);
		}
		{
					...
					if ((entityiterator.getCapability(EgoWeaponsModVars.PLAYER_VARIABLES_CAPABILITY, null)
						...
						if (entityiterator instanceof LivingEntity)
							((LivingEntity) entityiterator)
									.addEffect(new EffectInstance(Effects.HEAL, (int) 1, (int) 0, (false), (false)));
						if (entityiterator instanceof LivingEntity)
							((LivingEntity) entityiterator)
									.addEffect(new EffectInstance(Effects.REGENERATION, (int) 160, (int) 1, (false), (false)));
						if (world instanceof ServerWorld) {
							((ServerWorld) world).sendParticles(CrimsonfanparticleParticle.particle, (entityiterator.getX()),
