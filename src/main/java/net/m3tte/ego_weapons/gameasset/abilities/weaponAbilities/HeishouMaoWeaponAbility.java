...
public class HeishouMaoWeaponAbility extends ItemAbility {
    ...
    public int getBlipCost(PlayerEntity player, PlayerVariables playerVars) {
        ...
        return deductLightDecreases(player, AbilityUtils.AbilityType.WEAPON,7);
    }

    @Override
    public ResourceLocation getIconLocation(PlayerEntity player, PlayerVariables vars) {
        return AbilityUtils.getAbilityIcon("cursewrit_butcherblade");
    ...
    public void trigger(PlayerEntity player, PlayerVariables playerVars) {
        ...
        if (canTrigger(player, playerVars)) {
            ...
            entitypatch.playAnimationSynchronized(HeishouMaoBranchAnims.HEISHOU_MAO_SPECIAL_1, 0.1f);
            /*if (world instanceof ServerWorld) {
