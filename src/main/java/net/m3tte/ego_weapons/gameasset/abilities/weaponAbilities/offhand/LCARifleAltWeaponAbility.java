package net.m3tte.ego_weapons.gameasset.abilities.weaponAbilities.offhand;
...
public class LCARifleAltWeaponAbility extends ItemAbility {
    ...
    public void trigger(PlayerEntity player, PlayerVariables playerVars) {
        ...
        if (canTrigger(player, playerVars)) {
            ...
            entitypatch.playAnimationSynchronized(LCARifleMovesetAnims.LCA_RIFLE_SPECIAL_O_1, 0.1f);
            /*if (world instanceof ServerWorld) {
