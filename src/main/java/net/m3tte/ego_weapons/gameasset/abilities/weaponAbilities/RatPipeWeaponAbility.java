...
public class RatPipeWeaponAbility extends ItemAbility {
    ...
    public int getBlipCost(PlayerEntity player, PlayerVariables playerVars) {
        ...
        return deductLightDecreases(player, AbilityUtils.AbilityType.WEAPON,6);
    }

    @Override
    public ResourceLocation getIconLocation(PlayerEntity player, PlayerVariables vars) {
        return AbilityUtils.getAbilityIcon("skullcracker");
    ...
    public void trigger(PlayerEntity player, PlayerVariables playerVars) {
        ...
        if (canTrigger(player, playerVars)) {
            ...
            entitypatch.playAnimationSynchronized(RatPipeMovesetAnims.RAT_PIPE_SPECIAL_1, 0.01f);
            DialogueSystem.speakEvalDialogue(player, "dialogue.ego_weapons.skills.rat_pipe.1", DialogueSystem.DialogueTypes.SKILL, TextFormatting.WHITE);
