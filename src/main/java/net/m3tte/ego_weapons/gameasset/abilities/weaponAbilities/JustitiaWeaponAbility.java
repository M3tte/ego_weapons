...
public class JustitiaWeaponAbility extends ItemAbility {
    ...
    public int getBlipCost(PlayerEntity player, PlayerVariables playerVars) {
        ...
        return deductLightDecreases(player, AbilityUtils.AbilityType.WEAPON,9);
    }

    @Override
    public ResourceLocation getIconLocation(PlayerEntity player, PlayerVariables vars) {
        return AbilityUtils.getAbilityIcon("judgement");
    ...
    public void trigger(PlayerEntity player, PlayerVariables playerVars) {
        ...
        if (canTrigger(player, playerVars)) {
            ...
            entitypatch.playAnimationSynchronized(JustitiaMovesetAnims.JUSTITIA_SPECIAL_1, 0.01f);
            /*if (world instanceof ServerWorld) {
