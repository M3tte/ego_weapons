...
import net.m3tte.ego_weapons.procedures.legacy.SwapFiringModePressProcedure;
...
public class SwapFiringModeKeyBinding extends EgoWeaponsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public SwapFiringModeKeyBinding(EgoWeaponsModElements instance) {
		super(instance, 200);
	}
	...
	public void initElements() {
		keys = new KeyBinding("key.ego_weapons.swap_firing_mode", GLFW.GLFW_KEY_Y, "key.categories.misc");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			SwapFiringModePressProcedure.executeProcedure(Stream
