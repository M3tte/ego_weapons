...
public class ArmorabilityKeyBinding extends EgoWeaponsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public ArmorabilityKeyBinding(EgoWeaponsModElements instance) {
		super(instance, 23);
	...
	public void initElements() {
		keys = new KeyBinding("key.ego_weapons.armorability", GLFW.GLFW_KEY_C, "key.categories.misc");
