...
public class WeaponabilityKeyBinding extends EgoWeaponsModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public WeaponabilityKeyBinding(EgoWeaponsModElements instance) {
		super(instance, 24);
	}
	...
	public void initElements() {
		keys = new KeyBinding("key.ego_weapons.weaponability", GLFW.GLFW_KEY_R, "key.categories.misc");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			WeaponAbilityProcedure.executeProcedure(Stream
