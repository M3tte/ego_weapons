...
@OnlyIn(Dist.CLIENT)
public class JustitiaScaleParticle extends HitParticle {
    ...
    public JustitiaScaleParticle(ClientWorld world, double x, double y, double z, double entityId, double ySpeed, double zSpeed, IAnimatedSprite animatedSprite) {
        ...
        this.amplitude = 0.02f + world.random.nextFloat() * 0.05f;
        ...
        this.quadSize = 0;
        this.setAlpha(0.4f + random.nextFloat() * 0.6f);
    }
    ...
    public void render(IVertexBuilder vertexBuilder, ActiveRenderInfo renderInfo, float partialTicks) {
        ...
        this.y = sourceEntity.getY() + 0.4f + Math.sin((this.age + partialTicks + this.startIdxTime) * this.floatSpeedMultiplier * (1 - ((this.age + partialTicks) / this.lifetime) * 0.5f)) * amplitude + this.age * gravityVal;
    ...
    public static class Provider implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            ...
            JustitiaScaleParticle particle = new JustitiaScaleParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet);
            return particle;
        }
