...
@OnlyIn(Dist.CLIENT)
public class EmberParticle extends HitParticle {
    ...
    double amplitude = 0;
    double gravityVal = 0;
    public EmberParticle(ClientWorld world, double x, double y, double z, double gravity, double floatAmplitude, double floatSpeedMult, IAnimatedSprite animatedSprite) {
    ...
    public static class Provider implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            ...
            EmberParticle particle = new EmberParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet);
            return particle;
        }
