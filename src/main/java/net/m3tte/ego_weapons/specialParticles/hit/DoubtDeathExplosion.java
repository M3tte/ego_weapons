...
import net.m3tte.ego_weapons.particle.RobotShrapnelParticle;
...
public class DoubtDeathExplosion extends MetaParticle {
    public DoubtDeathExplosion(ClientWorld level, double x, double y, double z, double width, double height, double _null) {
        ...
        this.level.addParticle(EgoWeaponsParticles.DOUBT_EXPLOSION_EFFECT.get(), this.x, this.y + 1, this.z, 0.0D, 0.0D, 0.0D);
        double d = 0.2F;
