...
@OnlyIn(Dist.CLIENT)
public class IngoingEmberParticle extends HitParticle {
    ...
    public IngoingEmberParticle(ClientWorld world, double x, double y, double z, double horizontalOffset, double verticalOffset, double time, IAnimatedSprite animatedSprite) {
        ...
        this.startX = (x + rand.nextFloat() * horizontalOffset * 2)-horizontalOffset;
        this.startZ = (z + rand.nextFloat() * horizontalOffset * 2)-horizontalOffset;
        this.startY = (y + rand.nextFloat() * verticalOffset * 2)-verticalOffset;
    ...
    public static class Provider implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            ...
            IngoingEmberParticle particle = new IngoingEmberParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet);
            return particle;
        }
