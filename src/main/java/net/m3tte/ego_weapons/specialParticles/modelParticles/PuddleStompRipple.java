...
public class PuddleStompRipple extends SpriteTexturedParticle {
    private final IAnimatedSprite spriteProvider;

    public PuddleStompRipple(ClientWorld world, double x, double y, double z, IAnimatedSprite spriteProvider) {
        super(world, x, y, z);
    ...
    public static class Provider implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            PuddleStompRipple particle = new PuddleStompRipple(worldIn, x, y, z, spriteSet);
            return particle;
        }
