...
import static net.minecraft.client.particle.IParticleRenderType.*;

public class DistortionParticleTest extends SpriteTexturedParticle {
    ...
    public DistortionParticleTest(ClientWorld world, double x, double y, double z, double xSpeed, double entityUUID, double zSpeed, IAnimatedSprite spriteProvider, float quadsize, int lifetime, Vector3f offset, Vector3f offsetRate, boolean glows) {
        super(world, x, y, z);
    ...
    public static class Provider implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double targetID, double sourceID) {
            DistortionParticleTest particle = new DistortionParticleTest(worldIn, x, y, z, 0, sourceID, 0, spriteSet, this.quadSize, this.lifetime, this.offset, this.offsetRate, this.glows);
            return particle;
        }
