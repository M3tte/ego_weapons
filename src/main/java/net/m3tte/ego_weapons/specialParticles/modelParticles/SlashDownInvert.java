...
public class SlashDownInvert extends RotationAttackParticle {
    ...
    public static class Provider implements IParticleFactory<BasicParticleType> {
        ...
        public Provider(IAnimatedSprite spriteSet, float quadSize, int lifeTime, Vector3f offsets) {
        ...
        public Particle createParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double targetID, double sourceID) {
            SlashDownInvert particle = new SlashDownInvert(worldIn, x, y, z, 0, targetID, sourceID, spriteSet, this.quadSize, this.lifetime, this.offset, this.offsetRate, this.glow);
            return particle;
        }
    }
}
