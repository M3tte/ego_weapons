...
public class RedMistEGOSuit extends GenericEgoWeaponsArmor {
	...
	static Item head = new RedMistEGOSuit(NoArmorToughnessMaterial.notoughness, EquipmentSlotType.HEAD, new Item.Properties().tab(EgoWeaponsCreativeTabs.EGO_WEAPONS)) {
		@Override
		@OnlyIn(Dist.CLIENT)
	...
	static Item chest = new RedMistEGOSuit(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().tab(EgoWeaponsCreativeTabs.EGO_WEAPONS), 0.5f, 0.5f, 1.0f ,1.6f, 0.8f, 0.5f, 1.3f, 10, 0) {
		...
		public void appendHoverText(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			TooltipFuncs.generateItemDescription(list, "desc.ego_weapons.red_mist_ego_armor.desc");
	...
	static Item legs = new RedMistEGOSuit(NoArmorToughnessMaterial.notoughness, EquipmentSlotType.LEGS, new Item.Properties().tab(EgoWeaponsCreativeTabs.EGO_WEAPONS)) {
		@Override
		@OnlyIn(Dist.CLIENT)
		public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
			BipedModel armorModel = new BipedModel(1);
