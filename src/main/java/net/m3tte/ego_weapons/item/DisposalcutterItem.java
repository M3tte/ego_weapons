...
import net.m3tte.ego_weapons.procedures.legacy.DisposalcutterhitProcedure;
...
public class DisposalcutterItem extends EgoWeaponsModElements.ModElement {
	@ObjectHolder("tcorp:disposal_cutter")
	public static final Item block = null;

	public DisposalcutterItem(EgoWeaponsModElements instance) {
		super(instance, 20);
	}
