...
public class BetasuppressionsuitItem extends EgoWeaponsModElements.ModElement {
	@ObjectHolder("tcorp:betasuppressionsuit_helmet")
	public static final Item helmet = null;
	@ObjectHolder("tcorp:betasuppressionsuit_chestplate")
	public static final Item body = null;
	@ObjectHolder("tcorp:betasuppressionsuit_leggings")
	public static final Item legs = null;
	@ObjectHolder("tcorp:betasuppressionsuit_boots")
	public static final Item boots = null;

	public BetasuppressionsuitItem(EgoWeaponsModElements instance) {
		super(instance, 9);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.CHEST, new Item.Properties().tab(ItemGroup.TAB_COMBAT)) {
			...
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				...
				armorModel.body = new Modelbeta_sup_suit().Body;
				armorModel.leftArm = new Modelbeta_sup_suit().LeftArm;
				armorModel.rightArm = new Modelbeta_sup_suit().RightArm;
			...
			public void appendHoverText(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("A protective suit made with BETA tier technology."));
				list.add(new StringTextComponent("[Ability] Fractal Distortion - 9 E"));
			}
		...
		}.setRegistryName("betasuppressionsuit_chestplate"));
	}

	// Made with Blockbench 4.6.5
	// Exported for Minecraft version 1.15 - 1.16 with MCP mappings
	// Paste this class into your mod and generate all required imports
	public static class Modelbeta_sup_suit extends EntityModel<Entity> {
		private final ModelRenderer Head;
		private final ModelRenderer Body;
		private final ModelRenderer Watch_r1;
		private final ModelRenderer RightArm;
		private final ModelRenderer LeftArm;
		private final ModelRenderer RightLeg;
		private final ModelRenderer LeftLeg;

		public Modelbeta_sup_suit() {
			texWidth = 72;
			texHeight = 64;
			...
			Head.texOffs(17, 48).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.5F, true);
			Body = new ModelRenderer(this);
			Body.setPos(0.0F, 0.0F, 0.0F);
			Body.texOffs(16, 0).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 0.0F, 0.27F, false);
			...
			Watch_r1 = new ModelRenderer(this);
			Watch_r1.setPos(0.0F, 0.0F, 0.0F);
			Body.addChild(Watch_r1);
			setRotationAngle(Watch_r1, 0.0F, 0.0F, 0.1309F);
			Watch_r1.texOffs(22, 46).addBox(-0.6F, 5.2F, -4.75F, 7.0F, 7.0F, 5.0F, -2.3F, false);
			Watch_r1.texOffs(15, 39).addBox(0.8F, 6.8F, -4.85F, 7.0F, 7.0F, 5.0F, -2.3F, false);
			...
			RightArm.texOffs(36, 34).addBox(-3.0F, 0.0F, -2.0F, 4.0F, 2.0F, 4.0F, 0.5F, false);
			RightArm.texOffs(0, 40).addBox(-4.125F, -1.5F, -2.3F, 2.0F, 5.0F, 5.0F, -1.4F, false);
