...
public class ZweiItem extends EgoWeaponsModElements.ModElement {
	@ObjectHolder("tcorp:zwei_helmet")
	public static final Item helmet = null;
	@ObjectHolder("tcorp:zwei_chestplate")
	public static final Item body = null;
	@ObjectHolder("tcorp:zwei_leggings")
	public static final Item legs = null;
	@ObjectHolder("tcorp:zwei_boots")
	public static final Item boots = null;

	public ZweiItem(EgoWeaponsModElements instance) {
		super(instance, 159);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().tab(ItemGroup.TAB_COMBAT)) {
			...
			public BipedModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlotType slot, BipedModel defaultModel) {
				...
				armorModel.body = new Modelzwei_uniform().Head;
			...
			public void appendHoverText(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("A fancy police cap. Used by the Zwei Association"));
			}

			@Override
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "tcorp:textures/entities/zwei_hat_texture.png";
			}
		}.setRegistryName("zwei_helmet"));
	}
