...
import net.m3tte.ego_weapons.procedures.legacy.JustiziahiteffectProcedure;
...
public class JustiziaItem extends EgoWeaponsModElements.ModElement {
	@ObjectHolder("tcorp:justizia")
	public static final Item block = null;

	public JustiziaItem(EgoWeaponsModElements instance) {
		super(instance, 144);
	}
