...
import net.m3tte.ego_weapons.procedures.legacy.RegretHitProcedure;
...
public class RegretItem extends EgoWeaponsModElements.ModElement {
	@ObjectHolder("tcorp:regret")
	public static final Item block = null;

	public RegretItem(EgoWeaponsModElements instance) {
		super(instance, 4);
	}
