...
import net.m3tte.ego_weapons.procedures.legacy.GalaxyorbLivingEntityIsHitWithToolProcedure;
...
public class GalaxyorbItem extends EgoWeaponsModElements.ModElement {
	@ObjectHolder("tcorp:galaxyorb")
	public static final Item block = null;

	public GalaxyorbItem(EgoWeaponsModElements instance) {
		super(instance, 91);
	}
