...
import net.m3tte.ego_weapons.procedures.legacy.WroughtaxehitProcedure;
...
public class LumbersaxeItem extends EgoWeaponsModElements.ModElement {
	@ObjectHolder("tcorp:lumbersaxe")
	public static final Item block = null;

	public LumbersaxeItem(EgoWeaponsModElements instance) {
		super(instance, 119);
	}
