...
import net.m3tte.ego_weapons.client.models.entities.NothingTherePhase2Model;
...
public class NothingThereRenderer {
    ...
    public static class NothingThereRender extends MobRenderer<NothingThere2Entity, NothingTherePhase2Model> {
        private static final ResourceLocation texture = new ResourceLocation("ego_weapons:textures/entities/abnos/nothing_there.png");
