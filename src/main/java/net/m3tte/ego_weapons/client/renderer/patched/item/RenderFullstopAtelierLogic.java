...
@OnlyIn(Dist.CLIENT)
public class RenderFullstopAtelierLogic extends RenderItemBase {
    private final ItemStack sheathStack;

    public RenderFullstopAtelierLogic() {
        this.sheathStack = EgoWeaponsItems.FULLSTOP_REP_PISTOL.get().getDefaultInstance();
    }
