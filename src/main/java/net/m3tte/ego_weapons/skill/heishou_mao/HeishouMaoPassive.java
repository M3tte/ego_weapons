...
public class HeishouMaoPassive extends Skill {
    public HeishouMaoPassive(Builder<? extends Skill> builder) {
        super(builder);
    }

    private static final UUID EVENT_UUID = UUID.fromString("a395b692-fd98-11eb-9c13-02b2ac131203");
    ...
    public void onRemoved(SkillContainer container) {
        ...
        if (bsguardskill.hasSkill(EgoWeaponsSkills.HEISHOU_MAO_GUARD)) {
