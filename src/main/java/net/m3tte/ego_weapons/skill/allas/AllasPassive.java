...
public class AllasPassive extends Skill {
    ...
    public void onInitiate(SkillContainer container) {
        ...
        if (!guard.isEmpty()) {
            container.getExecuter().getSkillCapability().skillContainers[GenericSkill.TC_GUARD.universalOrdinal()].setSkill(EgoWeaponsSkills.ALLAS_GUARD);
        }
    }
    ...
    public void onRemoved(SkillContainer container) {
        ...
        if (bsguardskill.hasSkill(EgoWeaponsSkills.ALLAS_GUARD)) {
