...
public class FullstopRepPassive extends Skill {
    public FullstopRepPassive(Builder<? extends Skill> builder) {
        super(builder);
    }
    ...
    public void onRemoved(SkillContainer container) {
        ...
        if (bsguardskill.hasSkill(EgoWeaponsSkills.FULLSTOP_REP_GUARD)) {
