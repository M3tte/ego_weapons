...
public class OeufiInnate extends SpecialAttackSkill {
    private static final UUID EVENT_UUID = UUID.fromString("f182777a-b2f9-12cb-4729-b242ac130af3");
    private StaticAnimation first;
    private StaticAnimation second;

    public OeufiInnate(Builder<? extends Skill> builder) {
        super(builder);
        this.first = OeufiAssocMovesetAnims.OEUFI_INNATE;
        this.second = OeufiAssocMovesetAnims.OEUFI_INNATE_2;
    }
