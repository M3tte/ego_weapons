...
public class ABSPassive extends Skill {
    public ABSPassive(Builder<? extends Skill> builder) {
        super(builder);
    }
    ...
    public void onInitiate(SkillContainer container) {
        ...
        if (!guard.isEmpty()) {
            container.getExecuter().getSkillCapability().skillContainers[GenericSkill.TC_GUARD.universalOrdinal()].setSkill(EgoWeaponsSkills.ARDOR_BLOSSOM_GUARD);
        }
    }
    ...
    public void onRemoved(SkillContainer container) {
        ...
        if (bsguardskill.hasSkill(EgoWeaponsSkills.ARDOR_BLOSSOM_GUARD)) {
