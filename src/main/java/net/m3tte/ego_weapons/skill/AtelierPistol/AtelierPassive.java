...
public class AtelierPassive extends Skill {
    ...
    public void onInitiate(SkillContainer container) {
        ...
        if (!guard.isEmpty()) {
            container.getExecuter().getSkillCapability().skillContainers[GenericSkill.TC_GUARD.universalOrdinal()].setSkill(EgoWeaponsSkills.ATELIER_GUARD);
        }
    }
    ...
    public void onRemoved(SkillContainer container) {
        ...
        if (bsguardskill.hasSkill(EgoWeaponsSkills.ATELIER_GUARD)) {
