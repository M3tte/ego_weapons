...
public class EthernalRestPotionEffect {
	@ObjectHolder("tcorp:ethernal_rest")
	...
	public static class EffectCustom extends Effect {
		...
		public void applyEffectTick(LivingEntity entity, int amplifier) {
			...
			if (world instanceof ServerWorld && entity.tickCount % 3 == 0) {
				((ServerWorld) world).sendParticles(TCorpParticleRegistry.SOLEMN_LAMENT_LIVING_BUTTERFLY.get(), (entity.getX()), (entity.getY() + entity.getBbHeight() / 2),
						(entity.getZ()), (int) 1, (entity.getBbWidth() / 2.5), (entity.getBbHeight() / 3), (entity.getBbWidth() / 2.5), 0.05);

				((ServerWorld) world).sendParticles(TCorpParticleRegistry.SOLEMN_LAMENT_DEPARTED_BUTTERFLY.get(), (entity.getX()), (entity.getY() + entity.getBbHeight() / 2),
						(entity.getZ()), (int) 1, (entity.getBbWidth() / 2.5), (entity.getBbHeight() / 3), (entity.getBbWidth() / 2.5), 0.05);
