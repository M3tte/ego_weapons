...
public class RangaclawlItem extends TcorpModElements.ModElement {
	@ObjectHolder("tcorp:ranga_claw_l")
	public static final Item block = null;

	public RangaclawlItem(TcorpModElements instance) {
		super(instance, 196);
	}
