...
public class ZelkovaaxeItem extends TcorpModElements.ModElement {
	@ObjectHolder("tcorp:zelkova_axe")
	public static final Item block = null;

	public ZelkovaaxeItem(TcorpModElements instance) {
		super(instance, 194);
	}
	...
	public void initElements() {
		...
		}, 1, -2.9f, new Item.Properties().tab(ItemGroup.TAB_COMBAT)) {
			@Override
