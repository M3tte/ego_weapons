...
import net.m3tte.tcorp.procedures.legacy.DefiledbladehitProcedure;
...
public class DefiledbladeItem extends TcorpModElements.ModElement {
	@ObjectHolder("tcorp:defiled_blade")
	public static final Item block = null;

	public DefiledbladeItem(TcorpModElements instance) {
		super(instance, 11);
	}
