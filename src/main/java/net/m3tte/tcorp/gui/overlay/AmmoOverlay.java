...
public class AmmoOverlay {
	...
	public static void eventHandler(RenderGameOverlayEvent.Post event) {
		if (event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (TCorpItems.ATELIER_LOGIC_PISTOLS.get().equals(entity.getMainHandItem().getItem())) {
			...
			else if (TCorpItems.ATELIER_LOGIC_SHOTGUN.get().equals(entity.getMainHandItem().getItem())) {
