...
public class BlackSilenceSwapGUI {
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("blacksilenceswapui"));
		}
	}
	...
	public static class ButtonPressedMessage {
		...
		public static void handler(ButtonPressedMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
			...
			context.enqueueWork(() -> {
				...
				handleWeaponSwap(entity, buttonID);
			});
	...
	static void handleWeaponSwap(PlayerEntity entity, int weaponIndex) {
		SwapWeapon.SwapWeapon(entity.level, entity, weaponIndex);
	}
