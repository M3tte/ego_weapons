...
public class BlacksilenceswapuiGuiWindow extends ContainerScreen<BlacksilenceswapuiGui.GuiContainerMod> {
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		...
		// Bottom Middle
		Minecraft.getInstance().getTextureManager().bind(new ResourceLocation("tcorp:textures/screens/blacksilence/durandal.png"));
		...
		Minecraft.getInstance().getTextureManager().bind(new ResourceLocation("tcorp:textures/screens/blacksilence/atelier_pistols.png"));
		this.blit(ms, this.leftPos + (int)((this.getXSize()/2)*1.52f)-17, this.topPos + (int)((this.getYSize()/2)*1.83f)-32, 0, 0, 32, 32, 32, 32);

		// Lower Middle Right
		Minecraft.getInstance().getTextureManager().bind(new ResourceLocation("tcorp:textures/screens/blacksilence/allas.png"));
		...
		Minecraft.getInstance().getTextureManager().bind(new ResourceLocation("tcorp:textures/screens/blacksilence/old_boys.png"));
		this.blit(ms, this.leftPos + (int)((this.getXSize()/2)*1.75f)-15, this.topPos + (int)((this.getYSize()/2)*0.85f)-31, 0, 0, 27, 27, 27, 27);

		// Top Right (Mook)
		Minecraft.getInstance().getTextureManager().bind(new ResourceLocation("tcorp:textures/screens/blacksilence/mook.png"));
		this.blit(ms, this.leftPos + (int)((this.getXSize()/2)*1.52f)-15, this.topPos + (int)((this.getYSize()/2)*0.42f)-30, 0, 0, 27, 27, 27, 27);

		// Top (Ranga)
		Minecraft.getInstance().getTextureManager().bind(new ResourceLocation("tcorp:textures/screens/blacksilence/ranga.png"));
		this.blit(ms, this.leftPos + (int)(this.getXSize()/1.95-18), this.topPos -9, 0, 0, 34, 34, 34, 34);

		// Top Left (Zelkova)
		Minecraft.getInstance().getTextureManager().bind(new ResourceLocation("tcorp:textures/screens/blacksilence/zelkova.png"));
		...
		Minecraft.getInstance().getTextureManager().bind(new ResourceLocation("tcorp:textures/screens/blacksilence/wheels.png"));
		this.blit(ms, this.leftPos + (int)((this.getXSize()/2)*0.31f)-14, this.topPos + (int)((this.getYSize()/2)*0.85f)-29, 0, 0, 26, 25, 25, 25);

		// Lower Middle Right
		Minecraft.getInstance().getTextureManager().bind(new ResourceLocation("tcorp:textures/screens/blacksilence/crystal_atelier.png"));
		...
		Minecraft.getInstance().getTextureManager().bind(new ResourceLocation("tcorp:textures/screens/blacksilence/atelier_shotgun.png"));
		this.blit(ms, this.leftPos + (int)((this.getXSize()/2)*0.55)-16, this.topPos + (int)((this.getYSize()/2)*1.83f)-32, 0, 0, 30, 30, 30, 30);

		// Bottom left
		Minecraft.getInstance().getTextureManager().bind(new ResourceLocation("tcorp:textures/screens/blacksilence/icon.png"));
