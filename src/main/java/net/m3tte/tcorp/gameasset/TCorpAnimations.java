...
public class TCorpAnimations {
    ...
    private static void build() {
        ...
        SOLEMN_LAMENT_AUTO_D0 = new BasicAttackAnimation(0.08F, 0.05F, 0.45F, 0.47F, 0.66F,null, "Tool_R", "biped/solemn_lament/auto_d0", biped)
                .addProperty(AttackAnimationProperty.LOCK_ROTATION, false)
                .addProperty(AttackPhaseProperty.MAX_STRIKES, ValueCorrector.setter(2))
                .addProperty(AttackPhaseProperty.SWING_SOUND, TCorpSounds.SOLEMN_LAMENT_READY)
                .addProperty(AttackPhaseProperty.STUN_TYPE, StunType.SHORT)
                .addProperty(AttackPhaseProperty.PARTICLE, TCorpParticleRegistry.SOLEMN_LAMENT_LIVING_HIT)
        ...
        SOLEMN_LAMENT_AUTO_D1 = new BasicAttackAnimation(0.08F, 0.05F, 0.45F, 0.47F, 0.66F,null, "Tool_L", "biped/solemn_lament/auto_d1", biped)
                .addProperty(AttackAnimationProperty.LOCK_ROTATION, false)
                .addProperty(AttackPhaseProperty.MAX_STRIKES, ValueCorrector.setter(2))
                .addProperty(AttackPhaseProperty.SWING_SOUND, TCorpSounds.PAPER_FLIP)
                .addProperty(AttackPhaseProperty.STUN_TYPE, StunType.SHORT)
                .addProperty(AttackPhaseProperty.PARTICLE, TCorpParticleRegistry.SOLEMN_LAMENT_DEPARTED_HIT)
                .addProperty(AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(1.2f))
                .addProperty(AttackAnimationProperty.LOCK_ROTATION, true)
                .addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 0.85f)
                .addProperty(AnimationProperty.ActionAnimationProperty.CANCELABLE_MOVE, false)
        ...
        SOLEMN_LAMENT_AUTO_D2 = new BasicAttackAnimation(0.08F, 0.05F, 0.06F, 0.07F, 0.7F,ColliderPreset.FIST, "Tool_R", "biped/solemn_lament/auto_d2", biped)
                ...
                .addProperty(AttackPhaseProperty.PARTICLE, TCorpParticleRegistry.SOLEMN_LAMENT_LIVING_HIT)
                .addProperty(AttackAnimationProperty.BASIS_ATTACK_SPEED, 0.9F)
                .addProperty(AttackPhaseProperty.SWING_SOUND, TCorpSounds.SOLEMN_LAMENT_SPIN)
                .addProperty(AnimationProperty.ActionAnimationProperty.CANCELABLE_MOVE, false);
        ...
        SOLEMN_LAMENT_RELOAD = (new ActionAnimation(0.1f, 1.5f,   "biped/solemn_lament/reload", biped))
                .addProperty(AnimationProperty.ActionAnimationProperty.STOP_MOVEMENT, true)
                .addProperty(AnimationProperty.ActionAnimationProperty.CANCELABLE_MOVE, false)
                .addProperty(StaticAnimationProperty.EVENTS, solemnLamentReloadEvent(TCorpSounds.SOLEMN_LAMENT_SPIN, 4, 2, 6))
                .addProperty(StaticAnimationProperty.PLAY_SPEED, 1f);
        ...
        SOLEMN_LAMENT_SPECIAL_ATTACK_RELOAD = (new ActionAnimation(0.1f, 1.5f,   "biped/solemn_lament/burst_reload", biped))
                .addProperty(AnimationProperty.ActionAnimationProperty.STOP_MOVEMENT, true)
                .addProperty(AnimationProperty.ActionAnimationProperty.CANCELABLE_MOVE, false)
                .addProperty(StaticAnimationProperty.EVENTS, solemnLamentReloadEvent(TCorpSounds.SOLEMN_LAMENT_SPIN, 2, 2, 4))
                .addProperty(StaticAnimationProperty.PLAY_SPEED, 1f);
    ...
    private static StaticAnimation.Event[] solemnLamentCharge(float timeEnd) {
        ...
        events[0] = StaticAnimation.Event.create(0, (entitypatch) -> {
            ...
            entitypatch.playSound(TCorpSounds.SOLEMN_LAMENT_READY, 1.3f, 1.3f);
            spawnArmatureParticle(entitypatch, 0, new Vector3d(0,-0.3,-0.4), 2, TCorpParticleRegistry.SOLEMN_LAMENT_LIVING_BUTTERFLY.get(), 0.1f, "Tool_R", false);
            spawnArmatureParticle(entitypatch, 0, new Vector3d(0,-0.3,-0.4), 2, TCorpParticleRegistry.SOLEMN_LAMENT_DEPARTED_BUTTERFLY.get(), 0.1f, "Tool_L", false);
        }, StaticAnimation.Event.Side.BOTH);
        ...
        events[1] = StaticAnimation.Event.create(timeEnd, (entitypatch) -> {
            ...
            if (entitypatch.getOriginal().getPersistentData().contains("solemnLamentChargeStaggered"))
                entitypatch.reserveAnimation(TCorpAnimations.SOLEMN_LAMENT_SPECIAL_ATTACK_RELOAD);
    ...
    private static StaticAnimation.Event[] solemnLamentDualEvent(float time) {
        ...
        events[0] = StaticAnimation.Event.create(time, (entitypatch) -> {
            ...
            entitypatch.playSound(TCorpSounds.SOLEMN_LAMENT_AUTO_BLACK, 1, 1);
            entitypatch.playSound(TCorpSounds.SOLEMN_LAMENT_AUTO_WHITE, 1, 1);
            spawnArmatureParticle(entitypatch, 0, new Vector3d(0,-0.2,-0.4), 1, TCorpParticleRegistry.SOLEMN_LAMENT_FIRE_DEPARTED.get(), 0, "Tool_L", false);
            spawnArmatureParticle(entitypatch, 0, new Vector3d(0,-0.5,-0.4), 2, TCorpParticleRegistry.SOLEMN_LAMENT_DEPARTED_BUTTERFLY.get(), 0.1f, "Tool_L" , false);
            spawnArmatureParticle(entitypatch, 0, new Vector3d(0,-1,-0.4), 2, TCorpParticleRegistry.SOLEMN_LAMENT_DEPARTED_BUTTERFLY.get(), 0.1f, "Tool_L" , false);
            spawnArmatureParticle(entitypatch, 0, new Vector3d(0,-1.5,-0.4), 2, TCorpParticleRegistry.SOLEMN_LAMENT_DEPARTED_BUTTERFLY.get(), 0.1f, "Tool_L" , false);
            spawnArmatureParticle(entitypatch, 0, new Vector3d(0,-2,-0.4), 2, TCorpParticleRegistry.SOLEMN_LAMENT_DEPARTED_BUTTERFLY.get(), 0.1f, "Tool_L" , false);
            spawnArmatureParticle(entitypatch, 0, new Vector3d(0,-3,-0.4), 2, TCorpParticleRegistry.SOLEMN_LAMENT_DEPARTED_BUTTERFLY.get(), 0.1f, "Tool_L" , false);

            spawnArmatureParticle(entitypatch, 0, new Vector3d(0,-0.2,-0.4), 1, TCorpParticleRegistry.SOLEMN_LAMENT_FIRE_LIVING.get(), 0, "Tool_R", false);
            spawnArmatureParticle(entitypatch, 0, new Vector3d(0,-0.5,-0.4), 2, TCorpParticleRegistry.SOLEMN_LAMENT_LIVING_BUTTERFLY.get(), 0.1f, "Tool_R" , false);
            spawnArmatureParticle(entitypatch, 0, new Vector3d(0,-1,-0.4), 2, TCorpParticleRegistry.SOLEMN_LAMENT_LIVING_BUTTERFLY.get(), 0.1f, "Tool_R" , false);
            spawnArmatureParticle(entitypatch, 0, new Vector3d(0,-1.5,-0.4), 2, TCorpParticleRegistry.SOLEMN_LAMENT_LIVING_BUTTERFLY.get(), 0.1f, "Tool_R" , false);
            spawnArmatureParticle(entitypatch, 0, new Vector3d(0,-2,-0.4), 2, TCorpParticleRegistry.SOLEMN_LAMENT_LIVING_BUTTERFLY.get(), 0.1f, "Tool_R" , false);
            spawnArmatureParticle(entitypatch, 0, new Vector3d(0,-3,-0.4), 2, TCorpParticleRegistry.SOLEMN_LAMENT_LIVING_BUTTERFLY.get(), 0.1f, "Tool_R" , false);
        ...
        events[1] = StaticAnimation.Event.create(0, (entitypatch) -> {
            ...
            entitypatch.playSound(TCorpSounds.GUARD_WIN, 1.3f, 1.3f);
            entitypatch.playSound(TCorpSounds.SOLEMN_LAMENT_SPIN, 1, 1);
            entitypatch.playSound(TCorpSounds.SOLEMN_LAMENT_SPIN, 0.7f, 0.7f);
        }, StaticAnimation.Event.Side.BOTH);
        events[2] = StaticAnimation.Event.create(0.4f, (entitypatch) -> {
            entitypatch.playSound(TCorpSounds.SOLEMN_LAMENT_READY, 1, 1);
            entitypatch.playSound(TCorpSounds.SOLEMN_LAMENT_READY, 0.7f, 0.7f);
        }, StaticAnimation.Event.Side.BOTH);
        return events;
    }
    ...
    private static StaticAnimation.Event[] solemnLamentReloadEvent(SoundEvent startSound, int baseReload, int bonus, int desparityPreset) {
        ...
        events[1] = StaticAnimation.Event.create(0.7f, (entitypatch) -> {
            entitypatch.playSound(TCorpSounds.SOLEMN_LAMENT_RELOAD, 1.3f, 1.3f);
            if (!entitypatch.getOriginal().level.isClientSide()) {
    ...
    private static StaticAnimation.Event[] solemnLamentDodgeReloadEvent() {
        ...
        events[0] = StaticAnimation.Event.create(0, (entitypatch) -> {
            ...
            entity.level.addParticle(EpicFightParticles.ENTITY_AFTER_IMAGE.get(), entity.getX(), entity.getY(), entity.getZ(), Double.longBitsToDouble(entity.getId()), 0, 0);
            entitypatch.playSound(TCorpSounds.GUARD_WIN, 1.3f, 1.3f);
            entitypatch.playSound(TCorpSounds.SOLEMN_LAMENT_SPIN, 1.3f, 1.3f);
            spawnArmatureParticle(entitypatch, 0, new Vector3d(0,-0.3,-0.4), 2, TCorpParticleRegistry.SOLEMN_LAMENT_LIVING_BUTTERFLY.get(), 0.1f, "Tool_R", false);
            spawnArmatureParticle(entitypatch, 0, new Vector3d(0,-0.3,-0.4), 2, TCorpParticleRegistry.SOLEMN_LAMENT_DEPARTED_BUTTERFLY.get(), 0.1f, "Tool_L", false);
        ...
        events[1] = StaticAnimation.Event.create(0.6f, (entitypatch) -> {
            entitypatch.playSound(TCorpSounds.SOLEMN_LAMENT_SPIN, 1.3f, 1.3f);
            entitypatch.playSound(TCorpSounds.SOLEMN_LAMENT_SPIN, 1f, 1f);
    ...
    private static StaticAnimation.Event[] ranga2Events() {
        ...
        events[1] = StaticAnimation.Event.create(0.7F, (entitypatch) -> {
            LivingEntity entity = entitypatch.getOriginal();
            entity.setItemInHand(Hand.MAIN_HAND, new ItemStack(TCorpItems.RANGA_DAGGER.get()));
        }, StaticAnimation.Event.Side.SERVER);
    ...
    private static StaticAnimation.Event[] rangaDaggerEvents() {
        ...
        events[0] = StaticAnimation.Event.create(0.3F, (entitypatch) -> {
            ...
            if (entity instanceof PlayerEntity) {
                ((PlayerEntity) entity).getCooldowns().addCooldown(TCorpItems.RANGA_DAGGER.get(), (int) 80);
                ((PlayerEntity) entity).getCooldowns().addCooldown(TCorpItems.RANGA_CLAW_L.get(), (int) 80);
                ((PlayerEntity) entity).getCooldowns().addCooldown(TCorpItems.RANGA_CLAW.get(), (int) 80);
            }
        ...
        events[1] = StaticAnimation.Event.create(1.5F, (entitypatch) -> {
            ...
            if (entity.getItemInHand(Hand.MAIN_HAND).equals(new ItemStack(TCorpItems.RANGA_DAGGER.get()), false))
