...
import static net.m3tte.tcorp.gameasset.TCorpAnimations.*;
import static net.m3tte.tcorp.potion.Shell.incrementShell;

public class TCorpMobAnimations {
    ...
    public static void build() {
        TCorpModels<?> models = FMLEnvironment.dist == Dist.CLIENT ? TCorpClientModels.LOGICAL_CLIENT : TCorpModels.LOGICAL_SERVER;
        ...
        DOUBT_AUTO_1 = (new BasicAttackAnimation(0.02F, 0.03F, 0.32F, 0.6F, 1F, TCorpCapabilityPresets.DoubtBlade, "Blade", "doubt/auto_1", doubt))
                .addProperty(AnimationProperty.AttackPhaseProperty.HIT_SOUND, TCorpSounds.DOUBT_HIT_LIGHT)
        ...
        DOUBT_AUTO_B1 = (new AttackAnimation(0.02F, 0.03F, 1.2F, 2.6F, 3F, TCorpCapabilityPresets.DoubtBlade, "Blade", "doubt/auto_c1", doubt))
                .addProperty(AnimationProperty.AttackPhaseProperty.HIT_SOUND, TCorpSounds.DOUBT_HIT_VERTICAL_FIRST)
                .addProperty(AnimationProperty.AttackPhaseProperty.PARTICLE, EpicFightParticles.HIT_BLADE)
                .addProperty(AnimationProperty.AttackPhaseProperty.SWING_SOUND, EpicFightSounds.WHOOSH)
                .addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE, ValueCorrector.multiplier(1.5f))
                .addProperty(StaticAnimationProperty.EVENTS, chargeSound(TCorpSounds.DOUBT_CHARGE))
                .addProperty(StaticAnimationProperty.PLAY_SPEED, 1.4f);

        DOUBT_AUTO_B2 = (new AttackAnimation(0.02F, 0.03F, 0.4F, 2F, 2.2F, TCorpCapabilityPresets.DoubtBlade, "Blade", "doubt/auto_c2", doubt))
                .addProperty(AnimationProperty.AttackPhaseProperty.HIT_SOUND, TCorpSounds.DOUBT_HIT_VERTICAL_SECOND)
                .addProperty(AnimationProperty.AttackPhaseProperty.PARTICLE, TCorpParticleRegistry.DOUBT_GROUNDSLAM_HIT)
                .addProperty(AnimationProperty.AttackPhaseProperty.SWING_SOUND, EpicFightSounds.WHOOSH)
        ...
        NT_AUTO_1 = (new BasicAttackAnimation(0.02F, 0.03F, 0.2F, 0.6F, 1.2F, TCorpCapabilityPresets.DoubtBlade, "Left_Forearm", "nothing_there/attack_1", nothing_there))
                .addProperty(AnimationProperty.AttackPhaseProperty.HIT_SOUND, TCorpSounds.NOTHING_THERE_SLASH)
                .addProperty(AnimationProperty.AttackPhaseProperty.PARTICLE, TCorpParticleRegistry.MIMICRY_HIT)
                .addProperty(AnimationProperty.AttackPhaseProperty.SWING_SOUND, TCorpSounds.NOTHING_THERE_SLASH_ALT)
        ...
        NT_AUTO_2 = (new BasicAttackAnimation(0.02F, 0.06F, 0.08F, 0.4F, 2.5F, TCorpCapabilityPresets.DoubtBlade, "Left_Forearm", "nothing_there/attack_2", nothing_there))
                .addProperty(AnimationProperty.AttackPhaseProperty.HIT_SOUND, TCorpSounds.NOTHING_THERE_BLUNT_ALT)
                .addProperty(AnimationProperty.AttackPhaseProperty.PARTICLE, EpicFightParticles.HIT_BLADE)
                .addProperty(AnimationProperty.AttackPhaseProperty.SWING_SOUND, EpicFightSounds.WHOOSH)
        ...
        NT_AUTO_B1 = (new BasicAttackAnimation(0.02F, 0.03F, 0.26F, 0.5F, 0.6F, TCorpCapabilityPresets.DoubtBlade, "Right_Forearm", "nothing_there/attack_b1", nothing_there))
                .addProperty(AnimationProperty.AttackPhaseProperty.HIT_SOUND, TCorpSounds.NOTHING_THERE_BLUNT_ALT)
                .addProperty(AnimationProperty.AttackPhaseProperty.PARTICLE, TCorpParticleRegistry.MIMICRY_DASH_HIT)
                .addProperty(AnimationProperty.AttackPhaseProperty.SWING_SOUND, EpicFightSounds.WHOOSH)
                .addProperty(AnimationProperty.AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(0.8f))
                .addProperty(AnimationProperty.AttackPhaseProperty.MAX_STRIKES, ValueCorrector.setter(4f))
                .addProperty(AnimationProperty.AttackPhaseProperty.STUN_TYPE, ExtendedDamageSource.StunType.LONG)
        ...
        NT_AUTO_STAB = (new BasicAttackAnimation(0.02F, 0.03F, 0.26F, 0.5F, 2F, TCorpCapabilityPresets.LONGER_BLADE, "Left_Claw", "nothing_there/attack_stab", nothing_there))
                .addProperty(AnimationProperty.AttackPhaseProperty.HIT_SOUND, TCorpSounds.NOTHING_THERE_BLUNT)
                .addProperty(AnimationProperty.AttackPhaseProperty.PARTICLE, TCorpParticleRegistry.MIMICRY_DASH_HIT)
                .addProperty(AnimationProperty.AttackPhaseProperty.SWING_SOUND, TCorpSounds.NOTHING_THERE_SLASH_ALT)
                ...
                .addProperty(AnimationProperty.AttackPhaseProperty.STUN_TYPE, ExtendedDamageSource.StunType.KNOCKDOWN)
                .addProperty(AnimationProperty.AttackAnimationProperty.COLLIDER_ADDER, 8)
                .addProperty(StaticAnimationProperty.EVENTS, chargeSound(TCorpSounds.NOTHING_THERE_HELLO))
                .addProperty(StaticAnimationProperty.PLAY_SPEED, 0.8f);
        ...
        NT_DASH_C = (new AttackAnimation(0.02F, 0.03F, 0.5F, 0.8F, 1.0F, TCorpCapabilityPresets.DoubtBlade, "Left_Forearm", "nothing_there/dash_claw", nothing_there))
                .addProperty(AnimationProperty.AttackPhaseProperty.HIT_SOUND, TCorpSounds.NOTHING_THERE_SLASH)
                .addProperty(AnimationProperty.AttackPhaseProperty.PARTICLE, TCorpParticleRegistry.MIMICRY_VERTICAL_HIT)
                .addProperty(AnimationProperty.AttackPhaseProperty.SWING_SOUND, TCorpSounds.NOTHING_THERE_SLASH_ALT)
                .addProperty(AnimationProperty.AttackPhaseProperty.MAX_STRIKES, ValueCorrector.setter(1f))
                .addProperty(AnimationProperty.AttackPhaseProperty.STUN_TYPE, ExtendedDamageSource.StunType.HOLD)
                .addProperty(AnimationProperty.AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(2f))
        ...
        NT_DASH_B = (new AttackAnimation(0.1F, 0.11F, 0.5F, 1.2F, 1.5F, TCorpCapabilityPresets.DoubtBlade, "Right_Bulb", "nothing_there/dash_blunt", nothing_there))
                ...
                .addProperty(AnimationProperty.AttackPhaseProperty.IMPACT, ValueCorrector.multiplier(2f))
                .addProperty(StaticAnimationProperty.EVENTS, chargeSound(TCorpSounds.NOTHING_THERE_HI))
                .addProperty(StaticAnimationProperty.PLAY_SPEED, 1f);
        ...
        NT_GOODBYE = (new BasicAttackAnimation(0.02F, 0.03F, 0.6F, 1F, 2F, TCorpCapabilityPresets.NTBlade, "Right_Blade", "nothing_there/goodbye", nothing_there))
                .addProperty(AnimationProperty.AttackPhaseProperty.HIT_SOUND, TCorpSounds.NOTHING_THERE_HEAVY_SLASH)
                .addProperty(AnimationProperty.AttackPhaseProperty.PARTICLE, TCorpParticleRegistry.MIMICRY_VERTICAL_HIT)
                .addProperty(AnimationProperty.AttackPhaseProperty.SWING_SOUND, TCorpSounds.NOTHING_THERE_SLASH_ALT)
                ...
                .addProperty(AnimationProperty.AttackAnimationProperty.COLLIDER_ADDER, 6)
                .addProperty(StaticAnimationProperty.EVENTS, chargeSound(TCorpSounds.NOTHING_THERE_GOODBYE))
                .addProperty(StaticAnimationProperty.PLAY_SPEED, 1f);
    ...
    private static StaticAnimation.Event[] ntScreech() {
        ...
        events[0] = StaticAnimation.Event.create(0, (entitypatch) -> {
            ...
            entitypatch.playSound(TCorpSounds.NOTHING_THERE_SCREECH_WINDUP, 0.7f,0.3f, 0.3f);
            entitypatch.playSound(TCorpSounds.NOTHING_THERE_SCREECH_FLESH, 1, 1);
        ...
        events[1] = StaticAnimation.Event.create(3.2f, (entitypatch) -> {
            ...
            if (charge > 15) {
                ...
                entitypatch.playSound(TCorpSounds.NOTHING_THERE_SCREECH_HIGH, 1, 1);
                ntScreechEvent(entitypatch.getOriginal().level, entitypatch.getOriginal().blockPosition(), entitypatch.getOriginal(), 8, 0.8f);
            } else {
                entitypatch.playSound(TCorpSounds.NOTHING_THERE_SCREECH_LOW, 1, 1);
    ...
    private static StaticAnimation.Event[] doubtDeathEffect(float delay) {
        ...
        events[0] = StaticAnimation.Event.create(0, (entitypatch) -> {
            ...
            if (world.isClientSide()) {
                world.playLocalSound(entity.position().x, entity.position().y, entity.position().z, TCorpSounds.DOUBT_DEATH, SoundCategory.HOSTILE, 1, 1, true);
            }
        ...
        events[1] = StaticAnimation.Event.create(delay, (entitypatch) -> {
            World world = entitypatch.getOriginal().level;
            LivingEntity entity = entitypatch.getOriginal();
            spawnArmatureParticle(entitypatch, 0, new Vector3d(0,-1,0), 1, TCorpParticleRegistry.DOUBT_EXPLODE.get(), 0, "Root", false);
    ...
    private static StaticAnimation.Event[] ntStompEvent() {
        ...
        events[0] = StaticAnimation.Event.create(0.75F, (entitypatch) -> {
            ...
            entitypatch.playSound(TCorpSounds.NOTHING_THERE_STOMP, 0.5f, 1, 1);
        }, StaticAnimation.Event.Side.BOTH);
