...
public class TcorpModElements {
	...
	public TcorpModElements() {
		try {
			ModFileScanData modFileInfo = ModList.get().getModFileById(TcorpMod.MODID).getFile().getScanResult();
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		protected final TcorpModElements elements;
		protected final int sortid;

		public ModElement(TcorpModElements elements, int sortid) {
