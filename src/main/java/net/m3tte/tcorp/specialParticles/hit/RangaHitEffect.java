...
@OnlyIn(Dist.CLIENT)
public class RangaHitEffect extends MetaParticle {
    public RangaHitEffect(ClientWorld world, double x, double y, double z, double width, double height, double _null) {
        super(world, x, y, z);
        ...
        this.level.addParticle(TCorpParticleRegistry.RANGA_STRIKE.get(), this.x, this.y + 1, this.z, 0.0D, 0.0D, 0.0D);
        double d = 0.2F;
    ...
    public static class Provider implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType typeIn, ClientWorld worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            RangaHitEffect particle = new RangaHitEffect(worldIn, x, y, z, xSpeed, ySpeed, zSpeed);
            return particle;
        }
    }
}