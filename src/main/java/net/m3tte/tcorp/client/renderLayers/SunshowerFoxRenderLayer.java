package net.m3tte.tcorp.client.renderLayers;
...
@OnlyIn(Dist.CLIENT)
public class SunshowerFoxRenderLayer<T extends PlayerEntity> extends LayerRenderer<T, PlayerModel<T>> {
    private final SunshowerFoxModel model = new SunshowerFoxModel();

    public SunshowerFoxRenderLayer(IEntityRenderer<T, PlayerModel<T>> p_i50929_1_) {
        super(p_i50929_1_);
    }
    ...
    private void render(MatrixStack p_229136_1_, IRenderTypeBuffer p_229136_2_, int p_229136_3_, T p_229136_4_, float p_229136_5_, float p_229136_6_, float p_229136_7_, float p_229136_8_, boolean p_229136_9_) {
        ...
        EntityType.byString(compoundnbt.getString("id")).filter((p_215344_0_) -> {
            return p_215344_0_ == TCorpModEntities.SUNSHOWER_FOX.get();
            ...
            IVertexBuilder ivertexbuilder = p_229136_2_.getBuffer(this.model.renderType(SunshowerFoxRenderer.SFoxRenderer.texture));
