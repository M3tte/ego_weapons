...
// Code diabolically inherited and roughly ported from: https://github.com/bottomtextdanny/Effective-Forge-/blob/1.19.2/src/main/java/bottomtextdanny/effective_fg/util/ParticleVoxel.java#L17
...
public class ParticleVoxel {
    ...
    public ParticleVoxel(AbstractParticleModel model) {
