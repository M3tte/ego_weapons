package net.m3tte.tcorp.client.renderer;
...
@OnlyIn(Dist.CLIENT)
public class TCorpRenderTypes extends RenderType {
    public TCorpRenderTypes(String p_i225992_1_, VertexFormat p_i225992_2_, int p_i225992_3_, int p_i225992_4_, boolean p_i225992_5_, boolean p_i225992_6_, Runnable p_i225992_7_, Runnable p_i225992_8_) {
    ...
    static {
        RISK_INDICATOR = (textureLocation) -> {
            ...
            return create("tcorp:risk_indicator", DefaultVertexFormats.POSITION_TEX, 7, 256, true, false, state);
        };
