...
import net.m3tte.tcorp.client.models.entities.DawnOfGreenDoubtAModel;
...
public class DawnOfGreenDoubtRenderer {
    ...
    public static class GreenDoubtRenderer extends MobRenderer<DawnOfGreenDoubtEntity, DawnOfGreenDoubtAModel> {
        private static final ResourceLocation texture = new ResourceLocation("tcorp:textures/entities/abnos/doubt_a.png");
