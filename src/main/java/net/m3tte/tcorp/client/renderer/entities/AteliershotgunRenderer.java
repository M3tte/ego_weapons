...
public class AteliershotgunRenderer {
	...
	public static class CustomRender extends EntityRenderer<AtelierShotgunBullet.AtelierShotgunSlugProj> {
		...
		@Override
		public void render(AtelierShotgunBullet.AtelierShotgunSlugProj entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
		...
		@Override
		public ResourceLocation getTextureLocation(AtelierShotgunBullet.AtelierShotgunSlugProj p_110775_1_) {
			return texture;
		}
