...
public class AtelierpistolsRenderer {
	...
	@OnlyIn(Dist.CLIENT)
	public static class CustomRender extends EntityRenderer<AtelierPistolsBullet.AtelierPistolBulletProj> {
		...
		@Override
		public void render(AtelierPistolsBullet.AtelierPistolBulletProj entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
		...
		@Override
		public ResourceLocation getTextureLocation(AtelierPistolsBullet.AtelierPistolBulletProj p_110775_1_) {
			return texture;
		}
