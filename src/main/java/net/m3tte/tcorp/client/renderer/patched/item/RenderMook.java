...
package net.m3tte.tcorp.client.renderer.patched.item;
...
@OnlyIn(Dist.CLIENT)
public class RenderMook extends RenderItemBase {
    private final ItemStack sheathStack;

    public RenderMook() {
        this.sheathStack = ForgeRegistries.ITEMS.getValue(ResourceLocation.of("tcorp:mook_sheath", ':')).getItem().getDefaultInstance();
    }
