...
public class NothingThere2Entity extends MonsterEntity {
    ...
    protected SoundEvent getStepSound() {
        return TCorpSounds.NOTHING_THERE_WALK;
    }
    ...
    protected SoundEvent getAmbientSound() {
        ...
        switch(sound) {
            default: return TCorpSounds.NOTHING_THERE_VOICE_1;
            case 1: return TCorpSounds.NOTHING_THERE_VOICE_2;
            case 2: return TCorpSounds.NOTHING_THERE_VOICE_3;
            case 3: return TCorpSounds.NOTHING_THERE_VOICE_4;
        }
    }
    ...
    public void playAmbientSound() {
        ...
        this.playSound(this.random.nextBoolean() ? TCorpSounds.NOTHING_THERE_IDLE_1 : TCorpSounds.NOTHING_THERE_IDLE_2, this.getSoundVolume(), this.getVoicePitch());
    }
