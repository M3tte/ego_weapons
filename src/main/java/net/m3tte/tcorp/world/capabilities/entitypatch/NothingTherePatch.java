...
public class NothingTherePatch extends MobPatch<NothingThere2Entity> implements StaggerableEntity {
    ...
    public static final CombatBehaviors.Builder<NothingTherePatch> STANDARD = CombatBehaviors.<NothingTherePatch>builder()
            .newBehaviorSeries(
                    BehaviorSeries.<NothingTherePatch>builder().weight(100.0F).canBeInterrupted(true).looping(true)
                            .nextBehavior(Behavior.<NothingTherePatch>builder().animationBehavior(TCorpMobAnimations.NT_AUTO_1).withinEyeHeight().withinDistance(0.0D, 3D))
                            .nextBehavior(Behavior.<NothingTherePatch>builder().animationBehavior(TCorpMobAnimations.NT_AUTO_2).withinEyeHeight().withinDistance(0.0D, 6D))
            )
            .newBehaviorSeries(
                    BehaviorSeries.<NothingTherePatch>builder().weight(50.0F).canBeInterrupted(true).looping(true)
                            .nextBehavior(Behavior.<NothingTherePatch>builder().animationBehavior(TCorpMobAnimations.NT_AUTO_B1).withinEyeHeight().withinDistance(0.0D, 3D))
                            .nextBehavior(Behavior.<NothingTherePatch>builder().animationBehavior(TCorpMobAnimations.NT_AUTO_B2).withinEyeHeight().withinDistance(0.0D, 6D))
            )
            .newBehaviorSeries(
                    BehaviorSeries.<NothingTherePatch>builder().weight(200.0F).canBeInterrupted(true).looping(true)
                            .nextBehavior(Behavior.<NothingTherePatch>builder().animationBehavior(TCorpMobAnimations.NT_AUTO_STAB).withinEyeHeight().withinDistance(0.0D, 1.8D))
            )
            .newBehaviorSeries(
                    BehaviorSeries.<NothingTherePatch>builder().weight(60.0F).canBeInterrupted(true).looping(true).cooldown(60)
                            .nextBehavior(Behavior.<NothingTherePatch>builder().animationBehavior(TCorpMobAnimations.NT_DASH_C).withinEyeHeight().withinDistance(4D, 7D))
            )
            .newBehaviorSeries(
                    BehaviorSeries.<NothingTherePatch>builder().weight(30.0F).canBeInterrupted(true).looping(true).cooldown(60)
                            .nextBehavior(Behavior.<NothingTherePatch>builder().animationBehavior(TCorpMobAnimations.NT_DASH_B).withinEyeHeight().withinDistance(4D, 7D))
            )
            .newBehaviorSeries(
                    BehaviorSeries.<NothingTherePatch>builder().weight(20.0F).canBeInterrupted(true).looping(true).cooldown(60)
                            .nextBehavior(Behavior.<NothingTherePatch>builder().animationBehavior(TCorpMobAnimations.NT_GOODBYE).withinEyeHeight().withinDistance(0.0D, 3D))
            )
            .newBehaviorSeries(
                    BehaviorSeries.<NothingTherePatch>builder().weight(5.0F).canBeInterrupted(true).looping(true).cooldown(60)
                            .nextBehavior(Behavior.<NothingTherePatch>builder().animationBehavior(TCorpMobAnimations.NT_SCREECH).withinEyeHeight().withinDistance(0.0D, 5D).custom((nt) -> !nt.original.hasEffect(Shell.get())))
            )
            .newBehaviorSeries(
                    BehaviorSeries.<NothingTherePatch>builder().weight(60.0F).canBeInterrupted(true).looping(true).cooldown(60)
                            .nextBehavior(Behavior.<NothingTherePatch>builder().animationBehavior(TCorpMobAnimations.NT_STOMP).withinEyeHeight().withinDistance(0.0D, 3D))
            );
    ...
    public void initAnimator(ClientAnimator clientAnimator) {
        clientAnimator.addLivingAnimation(LivingMotions.IDLE, TCorpMobAnimations.NT_IDLE);
        clientAnimator.addLivingAnimation(LivingMotions.WALK, TCorpMobAnimations.NT_WALK);
        clientAnimator.addLivingAnimation(LivingMotions.CHASE, TCorpMobAnimations.NT_WALK);
        clientAnimator.addLivingAnimation(LivingMotions.FALL, TCorpMobAnimations.NT_IDLE);
        clientAnimator.addLivingAnimation(LivingMotions.MOUNT, TCorpMobAnimations.NT_IDLE);
        clientAnimator.addLivingAnimation(LivingMotions.DEATH, TCorpMobAnimations.NT_IDLE);
    ...
    public void processSpawnData(ByteBuf buf) {
        ...
        animator.addLivingAnimation(LivingMotions.IDLE, TCorpMobAnimations.NT_IDLE);
        animator.addLivingAnimation(LivingMotions.WALK, TCorpMobAnimations.NT_WALK);
        animator.addLivingAnimation(LivingMotions.CHASE, TCorpMobAnimations.NT_WALK);
    ...
    public <M extends Model> M getEntityModel(Models<M> models) {
        return models.get(new ResourceLocation(TcorpMod.MODID, "entity/nothing_there"));
    }
