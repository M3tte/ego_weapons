package net.m3tte.tcorp.world.capabilities.stagger;

import net.m3tte.tcorp.*;
import net.m3tte.tcorp.gameasset.TCorpAnimations;
import net.m3tte.tcorp.network.TCorpPackageHandler;
...
public class StaggerSystem {
    ...
    public static void stagger(LivingEntity entity) {
        if (entity instanceof PlayerEntity) {
        ...
        if (!entity.hasEffect(Staggered.get()) && entity.isAlive()) {
            ...
            if (!entity.level.isClientSide) {
                ...
                TcorpMod.PACKET_HANDLER.send(PacketDistributor.ALL.noArg(), new TCorpPackageHandler.SendStaggerMessage(entity.getId()));
            }
