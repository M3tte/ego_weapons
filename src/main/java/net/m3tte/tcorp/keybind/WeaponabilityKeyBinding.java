...
public class WeaponabilityKeyBinding extends TcorpModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.tcorp.weaponability", GLFW.GLFW_KEY_R, "key.categories.misc");
