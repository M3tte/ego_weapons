...
public class SwapFiringModeKeyBinding extends TcorpModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.tcorp.swap_firing_mode", GLFW.GLFW_KEY_Y, "key.categories.misc");
