...
import net.m3tte.tcorp.procedures.legacy.OpenattrinterfaceOnKeyPressedProcedure;
...
public class OpenattrinterfaceKeyBinding extends TcorpModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.tcorp.openattrinterface", GLFW.GLFW_KEY_N, "key.categories.misc");
