...
public class CrimsonfanprojRenderer {
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(CrimsonfanprojItem.arrow, renderManager -> new CustomRender(renderManager));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public static class CustomRender extends EntityRenderer<CrimsonfanprojItem.ArrowCustomEntity> {
		private static final ResourceLocation texture = new ResourceLocation("tcorp:textures/entities/wind_slash.png");
		...
		@Override
		public void render(CrimsonfanprojItem.ArrowCustomEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
		...
		@Override
		public ResourceLocation getTextureLocation(CrimsonfanprojItem.ArrowCustomEntity p_110775_1_) {
			return texture;
		}
