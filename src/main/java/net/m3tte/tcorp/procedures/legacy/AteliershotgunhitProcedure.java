	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				TcorpMod.LOGGER.warn("Failed to load dependency world for procedure Ateliershotgunhit!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				TcorpMod.LOGGER.warn("Failed to load dependency x for procedure Ateliershotgunhit!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				TcorpMod.LOGGER.warn("Failed to load dependency y for procedure Ateliershotgunhit!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				TcorpMod.LOGGER.warn("Failed to load dependency z for procedure Ateliershotgunhit!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				TcorpMod.LOGGER.warn("Failed to load dependency entity for procedure Ateliershotgunhit!");
			return;
		}
		if (dependencies.get("sourceentity") == null) {
			if (!dependencies.containsKey("sourceentity"))
				TcorpMod.LOGGER.warn("Failed to load dependency sourceentity for procedure Ateliershotgunhit!");
			return;
		}
		...
		if (new Object() {
			...
			if (world instanceof ServerWorld) {
				((ServerWorld) world).sendParticles(TCorpParticleRegistry.ATELIER_SHOTGUN_HIT.get(), (entity.getX()), (entity.getY()),
				...
				if (sourceentity.getPersistentData().getDouble("furiosohits") >= 10) {
					...
					if (entitypatch != null) {
						if (entitypatch.getHitAnimation(ExtendedDamageSource.StunType.LONG) == Animations.BIPED_HIT_LONG)
							entitypatch.playAnimationSynchronized(TCorpAnimations.RANGA_GUARD_STAGGER, 0);
					}
				}
			}
		} else {
