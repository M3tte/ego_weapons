...
public class JustiziaArmorAbility extends ItemAbility {
    ...
    public void trigger(PlayerEntity player, TcorpModVariables.PlayerVariables playerVars) {
        ...
        if (playerVars.blips > 6) {
            ...
            player.playSound(TCorpSounds.OMINOUS_BELL, 1, 1);
            ...
            for (Entity targetEnt : foundHostiles) {
                if (targetEnt instanceof PlayerEntity) {
                    ...
                    TcorpModVariables.PlayerVariables targetPlayerVars = targetLiving.getCapability(PLAYER_VARIABLES_CAPABILITY, null).orElse(null);
