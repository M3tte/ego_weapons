...
public class OldBoysPassive extends Skill {
    ...
    public void onInitiate(SkillContainer container) {
        ...
        if (!guard.isEmpty()) {
            container.getExecuter().getSkillCapability().skillContainers[GenericSkill.TC_GUARD.universalOrdinal()].setSkill(TCorpSkills.OLD_BOYS_GUARD);
        }
    }
    ...
    public void onRemoved(SkillContainer container) {
        ...
        if (bsguardskill.hasSkill(TCorpSkills.OLD_BOYS_GUARD)) {
