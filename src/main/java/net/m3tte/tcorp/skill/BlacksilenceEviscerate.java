...
public class BlacksilenceEviscerate extends SpecialAttackSkill {
    ...
    public BlacksilenceEviscerate(Builder<? extends Skill> builder) {
        super(builder);
        this.first = TCorpAnimations.RANGA_EVISCERATE_1;
        this.second = TCorpAnimations.RANGA_EVISCERATE_2;
    }
    ...
    public void onInitiate(SkillContainer container) {
        ...
        container.getExecuter().getEventListener().addEventListener(EventType.ATTACK_ANIMATION_END_EVENT, EVENT_UUID, (event) -> {
            if (event.getAnimationId() == TCorpAnimations.RANGA_EVISCERATE_1.getId()) {
