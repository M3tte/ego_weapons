...
public class SolemnLamentPassive extends Skill {
    ...
    public void onInitiate(SkillContainer container) {
        ...
        if (!guard.isEmpty()) {
            container.getExecuter().getSkillCapability().skillContainers[GenericSkill.TC_GUARD.universalOrdinal()].setSkill(TCorpSkills.SOLEMN_LAMENT_GUARD);
        }
    ...
    public void onRemoved(SkillContainer container) {
        ...
        if (bsguardskill.hasSkill(TCorpSkills.SOLEMN_LAMENT_GUARD)) {
