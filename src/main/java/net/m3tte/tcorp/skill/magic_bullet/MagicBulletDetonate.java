...
public class MagicBulletDetonate extends SpecialAttackSkill {
    ...
    public MagicBulletDetonate(Builder<? extends Skill> builder) {
        super(builder);
        this.first = TCorpAnimations.MAGIC_BULLET_SPIN_1;
        this.second = TCorpAnimations.MAGIC_BULLET_SPIN_2;
    }
    ...
    public void onInitiate(SkillContainer container) {
        ...
        container.getExecuter().getEventListener().addEventListener(EventType.ATTACK_ANIMATION_END_EVENT, EVENT_UUID, (event) -> {
            if (event.getAnimationId() == TCorpAnimations.MAGIC_BULLET_SPIN_1.getId()) {
