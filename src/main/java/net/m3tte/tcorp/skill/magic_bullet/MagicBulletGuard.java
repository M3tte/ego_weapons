...
public class MagicBulletGuard extends EnergizingGuardSkill {
    public MagicBulletGuard(Builder builder) {
        super(builder);
    }
    ...
    public static Builder createBuilder(ResourceLocation resourceLocation) {
        return GuardSkill.createBuilder(resourceLocation)
                .addAdvancedGuardMotion(TCorpCategories.MAGIC_BULLET, (item, player) -> TCorpAnimations.MAGIC_BULLET_GUARD_HIT)
                .addGuardMotion(TCorpCategories.MAGIC_BULLET, (item, player) -> TCorpAnimations.MAGIC_BULLET_GUARD_HIT)
                .addGuardBreakMotion(TCorpCategories.MAGIC_BULLET, (item, player) -> TCorpAnimations.RANGA_GUARD_STAGGER);
    }
